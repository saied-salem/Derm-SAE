...
def load_checkpoint(model, checkpoint_path, strict=True):
    ...
    if position_id_key in state_dict and not hasattr(model, position_id_key):
        print(f"\n\nDeleting position_id_key: {position_id_key}\n\n")
        del state_dict[position_id_key]
    resize_pos_embed(state_dict, model)
    resize_text_pos_embed(state_dict, model)
    # print("\n\nLoading checkpoint to model...\n\n", state_dict.keys())
    print(f"\n\nLoading checkpoint to model...\n\n", hasattr(state_dict, 'text.transformer.embeddings.position_ids'))
    print("\n\n finshed checking ")
    print("strict: ", strict)
    incompatible_keys = model.load_state_dict(state_dict, strict=False) ####CAUTION I changed strict to be False
    # print("\n\nIncompatible keys...\n\n", incompatible_keys)
